...
public:
     ...
     */
    [[nodiscard]] auto getPasswords() const -> std::vector<Password>;
     ...
     */
    [[nodiscard]] auto getPasswords(const std::string &) const -> std::vector<Password>;

    /**
     * Allows read access to currently loaded categories
     * @return const vector of strings with category names
     */
    [[nodiscard]] auto getCategories() const -> std::vector<std::string>;
     ...
     */
    [[nodiscard]] auto getTimestamp() const -> std::string;
     ...
     */
    auto setTimestamp(const std::string &timestamp) -> void;
     ...
     * @param params
     */
    auto sortPasswords(const std::vector<int> &params) -> void;
